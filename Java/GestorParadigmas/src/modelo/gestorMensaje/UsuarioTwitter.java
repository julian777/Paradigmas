...
public class UsuarioTwitter implements Serializable {
    ...
    public UsuarioTwitter(String usuario, String mensaje, Timestamp hora,
...
//recibe array de string con los datos, extrae e instancia el objeto con lo q le pasé
    public static UsuarioTwitter fromArray(ArrayList<String> datos) {
        ...
        return new UsuarioTwitter(usuario, mensaje, hora, lugar, hastag, medio, tema, estado);
    }
