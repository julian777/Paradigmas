...
<html>
    <head>
        ...
        <script type="text/javascript" src="seisbarras"></script>
    </head>
    <% ModeloTwitter.crearInstancia(getServletContext().getInitParameter("URL_servidor"));%>
     <% String datos = ModeloTwitter.getInstancia().getgUsuarios().datosGraficoCincoToJSON();%>
    <body onload="init()">
        ...
        <div id="canvas-holder">
            <canvas id="chart-area3" width="600" height="300"></canvas>
                ...
                <script src="js/seisbarras.js"></script>
    </body>
</html>
