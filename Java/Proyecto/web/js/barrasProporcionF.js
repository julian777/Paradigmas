...
function initProporcionF() {

    var patron1 = "[";
    var patron2 = '"';
    var patron3 = "]";

    var datos = document.getElementById("datosProporcionF").value;
    ...
    cargarGraficoProporcionF();

}

function cargarGraficoProporcionF() {
var a;
var tema = [];
...
var ctx = document.getElementById("chart-area2F").getContext("2d");
