...
var vector1 = [];
var vector2 = [];
function initSalvajeF() {

    var patron1 = "[";
    var patron2 = '"';
    var patron3 = "]";

    var datos = document.getElementById("datosHistogramaF").value;
...
function cargarGraficoaF() {
    ...
    var ctx4 = document.getElementById("chart-area1F").getContext("2d");
