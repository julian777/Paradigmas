...
function initFrecuenF() {

    var patron1 = "[";
    var patron2 = '"';
    var patron3 = "]";

    var datos = document.getElementById("datosFrecuenciaF").value;
    ...
    cargarGraficoFrecuenF();

}

function cargarGraficoFrecuenF() {
    ...
    var ctx3 = document.getElementById("chart-area3F").getContext("2d");
