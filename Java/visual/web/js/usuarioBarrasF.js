...
function initUsuarioF() {

    var patron1 = "[";
    var patron2 = '"';
    var patron3 = "]";

    var datos = document.getElementById("datosUsuarioF").value;
    ...
    cargarGraficoUsuarioF();

}

function cargarGraficoUsuarioF() {
    ...
    var ctx3 = document.getElementById("chart-area6F").getContext("2d");
